...
const Layout = () => {
  ...
  const isMemoryBlocksSection = pathname.startsWith("/memory/blocks") || pathname.startsWith("/memory/sessions") || pathname.startsWith("/memory/overview") || pathname.startsWith("/memory/search") || pathname.startsWith("/memory/system") || pathname.startsWith("/memory/journal");
